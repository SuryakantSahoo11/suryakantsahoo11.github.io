// @observablehq/runtime v4.17.9 Copyright 2021 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
function w(n, o, i, a) {
    ...
    p.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M4 7L0 1h8z' fill='currentColor' />\n  </svg>", p.appendChild(document.createTextNode(`${s}${d?" [":" {"}`)), p.addEventListener("mouseup", (function(e) {
        e.stopPropagation(), ae(h, O(n, null, i, a))
    })), l = l(n);
...
function* E(e) {
    for (let t = 0, n = e.length; t < n; ++t) t in e && (yield S(t, h(e, t), "observablehq--index"));
    for (const t in e) !n(t) && d(e, t) && (yield S(t, h(e, t), "observablehq--key"));
    for (const t of c(e)) yield S(i(t), h(e, t), "observablehq--symbol")
}
...
function O(e, n, o, i) {
    ...
    if (e instanceof Map ? e instanceof e.constructor ? (a = `Map(${e.size})`, s = M) : (a = "Map()", s = D) : e instanceof Set ? e instanceof e.constructor ? (a = `Set(${e.size})`, s = L) : (a = "Set()", s = D) : c ? (a = `${e.constructor.name}(${e.length})`, s = R) : (u = m(e)) ? (a = `Immutable.${u.name}${"Record"===u.name?"":`(${e.size})`}`, c = u.arrayish, s = u.arrayish ? U : u.setish ? k : F) : (a = f(e), s = D), n) {
        ...
        return t.className = "observablehq--shallow", o && t.appendChild(r(o)), t.appendChild(document.createTextNode(a)), t.addEventListener("mouseup", (function(n) {
            T(t) || (n.stopPropagation(), ae(t, O(e)))
        })), t
    }
    ...
    h.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M7 4L1 8V0z' fill='currentColor' />\n  </svg>", h.appendChild(document.createTextNode(`${a}${c?" [":" {"}`)), d.addEventListener("mouseup", (function(t) {
        T(d) || (t.stopPropagation(), ae(d, w(e, 0, o, i)))
    }), !0), s = s(e);
...
var ke = Ue((async function(e, t) {
    ...
    if (!n.version && null != t && t.startsWith(Se)) {
        const e = await Le(Me(t.substring(Se.length)));
        n.version = e.dependencies && e.dependencies[n.name] || e.peerDependencies && e.peerDependencies[n.name]
    }
    if (n.path && !Te.test(n.path) && (n.path += ".js"), n.path && n.version && Ae.test(n.version)) return `${Se}${n.name}@${n.version}/${n.path}`;
    const r = await Le(n);
    return `${Se}${r.name}@${r.version}/${n.path||function(e){for(const t of Oe){const n=e[t];if("string"==typeof n)return Te.test(n)?n:`${n}.js`}}(r)||"index.js"}`
}));
...
function ze(e, t, n) {
    return {
        resolve: (r = n) => `https://cdn.jsdelivr.net/npm/${e}@${t}/${r}`
    }
}
Ie.amd = {};
...
class SQLiteDatabaseClient {
    ...
    async explain(e, t) {
        ...
        }, [ct((await this.query(`EXPLAIN QUERY PLAN ${e}`, t)).map((e => e.detail)).join("\n"))])
    }
    async describe(e) {
        ...
        return ut("table", {
            value: t
        }, [ut("thead", [ut("tr", n.map((e => ut("th", [ct(e)]))))]), ut("tbody", t.map((e => ut("tr", n.map((t => ut("td", [ct(e[t])])))))))])
    }
}
...
class Workbook {
    ...
    sheet(e, t) {
        ...
        return function(e, {
            ...
            for (let t = o; t <= a; t++) {
                const n = u[t - o] = Object.create(null, {
                        "#": {
                            value: t + 1
                        }
                    }),
...
class FileAttachment extends bt {
    constructor(e, t) {
        super(t), Object.defineProperty(this, "_url", {
            value: e
        })
    }
    async url() {
...
var xt = {
    ...
    element: function(e, t) {
        ...
        if (t)
            for (var a in t) o = (r = a).indexOf(":"), n = t[a], o >= 0 && "xmlns" !== (r = a.slice(0, o)) && (a = a.slice(o + 1)), wt.hasOwnProperty(r) ? i.setAttributeNS(wt[r], a, n) : i.setAttribute(a, n);
        return i
    },
    input: function(e) {
...
function Mt(e, t) {
    var n;
    return (n = Ot.get(e = +e)) ? n.then((() => t)) : (n = Date.now()) >= e ? Promise.resolve(t) : function(e, t) {
...
Object.defineProperties(Kt.prototype, {
    ...
    _resolve: {
        value: function(e) {
            ...
            if (!n)
                if (n = new Kt(2, this), this._builtins.has(e)) n.define(e, Vt(this._builtins.get(e)));
...
export {
    le as Inspector, It as Library, un as Runtime, Bt as RuntimeError
};